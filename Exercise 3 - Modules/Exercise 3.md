...
we delve into the practical aspects of module execution. We'll start by operating an interactive shell, proceeding to list and inject processes, then moving onto executing Binary Object Files (BOF). Finally, we'll explore privilege escalation through a common User Account Control (UAC) bypass technique.
...
## Interactive Shell
1. Enter interactive shell by clicking the arrow on the top right corner.
...
4. Find Notepad on the workstation by typing in `notepad` into the search bar.
...
13. Click on the most recent task and view the output from the BOF execution.
    ...
    <img width="523" alt="image" src="https://github.com/BC-SECURITY/Empire/assets/20302208/124dc2b4-16d4-40ca-86d1-102ac8037868">

    **NEED TO FIX AND REPLACE IMAGE**   
